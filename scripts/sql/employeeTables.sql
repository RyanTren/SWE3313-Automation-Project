...
(
    ...
    -- managers
    insert into jrestaurant_employees
        (name, role, username, password, hoursWorked)
    values
        ('Jeff', 'manager', 'm1user', 'm1password', 40);

    -- waiters
    insert into jrestaurant_employees
        (name, role, username, password, hoursWorked)
    values
        ('Sarah', 'waiter', 'w1user', 'w1password', 8.25),
    ...
    insert into jrestaurant_employees
        (name, role, username, password, hoursWorked)
    values
        ('Cameron', 'busboy', 'b1user', 'b1password', 6.5);

    -- cooks
    insert into jrestaurant_employees
        (name, role, username, password, hoursWorked)
    values
        ('Lily', 'cook', 'cuser1', 'c1password', 7),
